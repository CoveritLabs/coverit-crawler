...
class Config:
    ...
    ACTION_RETRY_COUNT: int = int(os.getenv("ACTION_RETRY_COUNT", 1))
    REPLAY_RETRY_COUNT: int = int(os.getenv("REPLAY_RETRY_COUNT", 1))
    POPUP_TIMEOUT_MS: int = int(os.getenv("POPUP_TIMEOUT_MS", 3000))

    DOM_QUIET_MS: int = int(os.getenv("DOM_QUIET_MS", 400))
    DOM_SETTLE_TIMEOUT_MS: int = int(os.getenv("DOM_SETTLE_TIMEOUT_MS", 3000))
